...
class Solution:
    ...
    def connect(self, root):
        ...
        if(root.left):
            ...
            if(root.nextRight):
                next = root.nextRight.left if(root.nextRight.left) else root.nextRight.right
                if(not root.left.nextRight):
                    root.left.nextRight = next
                else:
                    root.right.nextRight = next
        elif(root.right and root.nextRight):
                root.right.nextRight = root.nextRight.left if(root.nextRight.left) else root.nextRight.right
